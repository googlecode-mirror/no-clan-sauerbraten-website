...
var CalWidth=0;// calendar width
var CellWidth=10;// width of day cell.
...
var SpanBgColor = "#101210";//span background color
var WeekChar=2;//number of character for week day. if 2 then Mo,Tu,We. if 3 then Mon,Tue,Wed.
var DateSeparator="-";//Date Separator, you can change it to "-" if you want.
var ShowLongMonth=true;//Show long month name in Calendar header. example: "January".
var ShowMonthYear=true;//Show Month and Year in Calendar header.

var MonthYearColor="#101010";//Font Color of Month and Year in Calendar header.
var WeekHeadColor="#203020";//Background Color in Week header.
var SundayColor="#408060";//Background color of Sunday.
var SaturdayColor="#408060";//Background color of Saturday.
var WeekDayColor="#101210";//Background color of weekdays.
var FontColor="#aaffaa";//color of font in Calendar day cell.
var TodayColor="#aa3030";//Background color of today.
var SelDateColor="#d0d0d0";//Backgrond color of selected date in textbox.
var YrSelColor="#101010";//color of font of Year selector.
var MthSelColor="#401010";//color of font of Month selector if "MonthSelector" is "arrow".
var ThemeBg="";//Background image of Calendar window.
var CalBgColor="#f0f0f0";//Backgroud color of Calendar window.
...
function RenderCssCal(bNewCal) {
	...
	vCalHeader="<table "+CalBgColor+" style='background-color: white; border-collapse: collapse;' border=1 cellpadding=1 cellspacing=1 width='200' valign='top'>\n";
	...
	if (Cal.Scroller=="DROPDOWN") {
		...
		for (i = 2009; i < (dtToday.getFullYear() + 5);i++)	{
			if (i==Cal.Year)
				SelectStr="Selected";
			else
				SelectStr="";	
  ...
  //******************End Month and Year selector in arrow******************************
	...
	for (i=0;i<7;i++) {
		vCalHeader+="<td width='"+CellWidth+"' class='calTD'>"+WeekDayName[i].substr(0,WeekChar)+"</td>\n";
	}
	calHeight += 19;
	vCalHeader+="</tr>\n";	
	//Calendar detail
	...
	if (Cal.ShowTime) 
	{
		...
		vCalTime="\n<tr>\n<td colspan='7' align='center'><center>\n<table style='border-collapse: collapse;' width='199px' cellpadding='0' cellspacing='0'>\n<tr>\n<td height='5px' width='"+HourCellWidth+"'>&nbsp;</td>\n";
		...
		vCalTime+="<td align='center' width='22px'><input type='text' name='hour' maxlength=2 size=1 style=\"WIDTH: 22px; color:black;\" value="+showHour+" onChange=\"javascript:Cal.SetHour(this.value)\">";
		vCalTime+="</td><td align='center'>:</td><td align='center' width='22px'>";
		vCalTime+="<input type='text' name='minute' maxlength=2 size=1 style=\"WIDTH: 22px; color:black;\" value="+Cal.Minutes+" onChange=\"javascript:Cal.SetMinute(this.value)\">";
		
		if (Cal.ShowSeconds) {
			vCalTime+="</td><td align='center'>:</td><td align='center' width='22px'>";
			vCalTime+="<input type='text' name='second' maxlength=2 size=1 style=\"WIDTH: 22px; color:black;\" value="+Cal.Seconds+" onChange=\"javascript:Cal.SetSecond(parseInt(this.value,10))\">";
		}
		if (TimeMode==12) {
    ...
    {
        vCalTime+="<span id='close_cal' title='close' onmousedown='javascript:closewin(\"" + Cal.Ctrl + "\");' onmouseover='changeBorder(this, 0)' onmouseout='changeBorder(this, 1)' style='border:1px solid white; font-weight: bold; color: red;'>[X]</span></td>";
    }
	...
	if (winCal == undefined) {
	   ...
	   var cssStr = ".calTD {font-size: 12px; text-align: center;}\n";
	   cssStr+= ".calR {font-size: 12px; text-align: center; font-weight: bold; color: red;}"
